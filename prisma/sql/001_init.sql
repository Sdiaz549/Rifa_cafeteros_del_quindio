...
CREATE TABLE "Ticket" (
    ...
    "status" TEXT NOT NULL DEFAULT 'SIN_VENDER',
    "sellerId" TEXT,
    "buyerId" TEXT,
    "soldAt" DATETIME,
...
CREATE TABLE "BackupRecord" (
    ...
    "uploadedToDrive" BOOLEAN NOT NULL DEFAULT false,
    "driveFileId" TEXT,
...
CREATE TABLE "movimientos" (
    ...
    "notes" TEXT,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "movimientos_ticketId_fkey" FOREIGN KEY ("ticketId") REFERENCES "Ticket" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "movimientos_paymentId_fkey" FOREIGN KEY ("paymentId") REFERENCES "Payment" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "movimientos_expenseId_fkey" FOREIGN KEY ("expenseId") REFERENCES "Expense" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "movimientos_paymentMethodId_fkey" FOREIGN KEY ("paymentMethodId") REFERENCES "PaymentMethod" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "movimientos_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "movimientos_occurredAt_idx" ON "movimientos"("occurredAt");

-- CreateIndex
CREATE INDEX "movimientos_type_idx" ON "movimientos"("type");

-- CreateIndex
CREATE INDEX "movimientos_ticketId_idx" ON "movimientos"("ticketId");

-- CreateIndex
CREATE INDEX "movimientos_userId_idx" ON "movimientos"("userId");
